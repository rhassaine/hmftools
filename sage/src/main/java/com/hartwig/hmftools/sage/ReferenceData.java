...
// TODO: Only load non canonical transcripts when vcf is provided.
public class ReferenceData
{
    ...
    public ReferenceData(final SageCallConfig config, final ConfigBuilder configBuilder)
    {
        ...
        if(mConfig.Common.Visualiser.Enabled && mGeneDataCacheLoaded)
        {
    ...
    {
        GeneDataCache.setRequiredData(true, false, false, !mConfig.Common.Visualiser.Enabled);
